...
public class CraftChest extends CraftLootable<ChestBlockEntity> implements Chest {
    ...
    public Inventory getInventory() {
        ...
        if (nms instanceof com.mohistmc.banner.bukkit.DoubleChestInventory) {
            inventory = new CraftInventoryDoubleChest((com.mohistmc.banner.bukkit.DoubleChestInventory) nms);
        }
        return inventory;
    }
